...
class LSTM(object):
    def __int__(self, sequence_length, num_classes, vocab_size, embedding_size, l2_reg_lambda=0.0, num_hidden=100):

        #PLACEHOLDERS
        self.input_x = tf.placeholder(tf.int32, shape=[None, sequence_length], name="input_x")              #Data
        self.input_y = tf.placeholder(tf.float32, shape=[None, num_classes], name="input_y")                #Labels
